...
impl<'a> GameClient<'a> {
    ...
    pub fn update_game_mode(&mut self, delta_time: f64) {
        ...
        match self._game_phase {
            GamePhase::None => {
                game_ui_manager.set_game_image(MATERIAL_INTRO_IMAGE, 0.0, true);
