...
pub const CAMERA_OFFSET_Y: f32 = 0.5;
pub const CAMERA_SEA_HEIGHT_OFFSET: f32 = 3.0;
pub const CAMERA_ZOOM_SPEED: f32 = 4.0;
pub const CAMERA_POSITION_BLEND_SPEED_MIN: f32 = 1.0;
...
pub const JOYSTICK_SENSITIVITY: f32 = 0.1 / 32767.0;

// time
pub const TIME_OF_DAWN: f32 = 6.0;
pub const TIME_OF_EARLY_MORNING: f32 = 8.0;
pub const TIME_OF_MORNING: f32 = 10.0;
pub const TIME_OF_NOON: f32 = 12.0;
pub const TIME_OF_LATE_NOON: f32 = 16.0;
...
pub const WETNESS_DRY_RATE: f32 = 0.25;
...
pub const FALLING_HEIGHT: f32 = 5.0;
...
pub const RUNNING_MULTIPLIER_MIN: f32 = 1.5;
pub const RUNNING_MULTIPLIER_MAX: f32 = 2.5;
pub const RUNNING_MULTIPLIER_ACCELERATION: f32 = 1.0;
pub const MOVE_VELOCITY_DECAY: f32 = 10.0;
