...
impl CharacterAudioData {
    pub fn create_character_audio_data(audio_data_create_info: &CharacterAudioDataCreateInfo, engine_resources: &mut EngineResources) -> CharacterAudioData {
        CharacterAudioData {
...
impl CharacterAnimationData {
    pub fn create_character_animation_data(animation_data_create_info: &CharacterAnimationDataCreateInfo, engine_resources: &EngineResources) -> CharacterAnimationData {
        CharacterAnimationData {
            ...
            _kick_animation_animation: engine_resources.get_mesh_data(&animation_data_create_info._kick_animation_animation).clone(),
