...
use crate::game_module::game_service_locator::{
    get_game_client, get_game_client_mut, get_game_controller_mut, get_game_resources, get_game_ui_manager,
...
impl<'a> GameSceneManager<'a> {
    ...
    pub fn load_game_scene_save_data(&mut self, game_save_data: &GameSaveData) {
        ...
        game_ui_manager.load_table_storage_item_create_infos(&game_save_data._table_storage_item_create_info_list);
