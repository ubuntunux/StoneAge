...
impl<'a> GameMenuWidget<'a> {
    ...
    pub fn create_game_menu_widget(parent_widget: &mut WidgetDefault<'a>) -> Box<GameMenuWidget<'a>> {
        ...
        // Header Layout with 3 Tab Buttons
        ...
        let inventory_widget = InventoryWidget::create_inventory_widget(parent_widget);
        let save_load_widget = SaveLoadWidget::create_save_load_widget(parent_widget);
        let game_debug_menu_widget = GameDebugMenuWidget::create_game_debug_menu_widget(parent_widget);
    ...
    pub fn update_game_menu_widget(
        ...
        if switch_tab_next {
            let next_tab = match self._active_tab {
                GameMenuTab::Inventory => GameMenuTab::SaveLoad,
            ...
            let prev_tab = match self._active_tab {
                ...
                GameMenuTab::SaveLoad => GameMenuTab::Inventory,
