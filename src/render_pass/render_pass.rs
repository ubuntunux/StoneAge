...
pub fn register_render_pass_data_create_infos(
...
pub fn get_render_pass_data_create_infos(
    ...
    // render grass
    register_render_pass_data_create_infos(render_pass_data_create_info_map, &render_grass::get_render_pass_data_create_infos(renderer_context.get_renderer_data()));

    // render landscape
    register_render_pass_data_create_infos(render_pass_data_create_info_map, &render_landscape::get_render_pass_data_create_infos(renderer_context.get_renderer_data()));

    // PolygonNatureBiomes
    register_render_pass_data_create_infos(render_pass_data_create_info_map, &PolygonNatureBiomes::Standard::get_render_pass_data_create_infos(renderer_context.get_renderer_data()));
    register_render_pass_data_create_infos(render_pass_data_create_info_map, &PolygonNatureBiomes::TriplanarBasic::get_render_pass_data_create_infos(renderer_context.get_renderer_data()));
    register_render_pass_data_create_infos(render_pass_data_create_info_map, &PolygonNatureBiomes::VegetationShader::get_render_pass_data_create_infos(renderer_context.get_renderer_data()));
}
