...
pub fn get_render_pass_data_create_infos(
    ...
    register_render_pass_data_create_infos(
        ...
        &render_grass::get_render_pass_data_create_infos(renderer_context.get_renderer_data()),
    );

    // render landscape
    register_render_pass_data_create_infos(
        render_pass_data_create_info_map,
        &render_landscape::get_render_pass_data_create_infos(renderer_context.get_renderer_data()),
    );
