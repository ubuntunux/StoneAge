...
use ash::vk;
use rust_engine_3d::render_pass::render_object::render_forward_for_light_probe;
...
pub fn get_render_pass_data_create_info(
    ...
    let render_pass_name = render_forward_for_light_probe::get_render_pass_name(render_object_type, layer);
